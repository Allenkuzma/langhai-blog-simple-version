Langhai Blog  The simple version explains that this version is slowly updated and can be successfully built using the most basic component, MySQL Redis Mini.
[中文](./README.md)  
